...
Immediately after your first push, open a Draft Pull Request against main. This signals that work is in progress, allows early visibility, and triggers CI checks while you continue developing.
...
This repository supports three merge strategies:
    ...
    Squash and merge - Combines all commits into a single commit (recommended for cleaner history)
...
Once your PR is approved:
    ...
    Your branch will be deleted (unless configured otherwise)
